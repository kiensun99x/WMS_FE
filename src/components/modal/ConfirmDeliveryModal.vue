    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
      ...
      <div class="flex gap-3 p-6 border-t border-gray-200 justify-end">
        ...
        <button
          ...
          class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 active:bg-blue-800 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
...
import { confirmDelivery, getFailureReasons } from '@/services/order/orderService'
